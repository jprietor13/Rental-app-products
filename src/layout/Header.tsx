    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/70 glass-panel shadow-soft transition-all duration-300">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span
            className={`absolute -right-0.5 -top-0.5 flex h-5.5 min-w-5.5 items-center justify-center rounded-full border-2 border-white bg-red-500 px-1 text-[11px] font-bold leading-none text-white shadow-md transition-transform duration-200 ${count > 0 ? "scale-100" : "scale-0"}`}
          >
            {count}
          </span>
        </button>
